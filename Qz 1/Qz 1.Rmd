...
The server.R output name isn't the same as the plotOutput command used in ui.R.  Change myHist to newHist. Also if the plot doesn't render try dev.off() to reset before running again. It's been a persistent problem.